...
function GameDetail() {
    ...
    useLayoutEffect(() => {
        ...
        axios.get(`http://127.0.0.1:8000/api/history-${user.id}-${id}`).then((response) => {
    ...
    const handleRandom = (mode) => {
        ...
        console.log(position, irregular[position]);
    ...
    const gamePractice = (flag) => {
        if (!flag) {
            ...
            document.getElementById(cx('add-note-btn')).style.display = 'block';
        }
    };
                                ...
                                onClick={(e) => {
                                    axios
                                        .post('http://127.0.0.1:8000/api/notes', {
                                            word: irregular[position]['base'],
                                            part_of_speech: 'noun',
                                            meaning: irregular[position]['description'],
                                        })
                                        .then((response) => {
                        ...
                        <div className={cx('game-mode')}>
                            ...
                            <div className={cx('practice-mode')}>
                                <div className={cx('game-content')}>
                                    ...
                                    <div className={cx('game-fill')}>
                                        <input className={cx('text-field', 'practice-text-field')} id={cx('practice-v1')} />
                                        <input className={cx('text-field', 'practice-text-field')} id={cx('practice-v2')} />
                                        <input className={cx('text-field', 'practice-text-field')} id={cx('practice-v3')} />
                                    </div>
                                </div>
                            ...
                            <div className={cx('competition-mode')}>
                                <div className={cx('game-content')}>
                                    ...
                                    <div className={cx('game-fill')}>
                                        <input className={cx('text-field', 'competition-text-field')} id={cx('competition-v1')} />
                                        <input className={cx('text-field', 'competition-text-field')} id={cx('competition-v2')} />
                                        <input className={cx('text-field', 'competition-text-field')} id={cx('competition-v3')} />
                                    </div>
                                </div>
                                <div className={cx('btn-area')}>
                                    <button
